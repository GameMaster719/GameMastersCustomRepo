...
function c1015.initial_effect(c)
	...
	e2:SetCondition(c1015.condition)
	e2:SetOperation(c1015.operation)
	c:RegisterEffect(e2)
	--ATK Up
	...
	e3:SetOperation(c1015.operation2)
	c:RegisterEffect(e3)
end
function c1015.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetAttacker():IsControler(1-tp) and Duel.GetAttackTarget()==nil
end
function c1015.operation(e,tp,eg,ep,ev,re,r,rp)
	Duel.ChangeBattleDamage(tp,ev/2)
end
function c1015.operation2(e,tp,eg,ep,ev,re,r,rp)
