...
function c30000017.initial_effect(c)
	...
	e2:SetCountLimit(1,30000017)
	e2:SetTarget(c30000017.sptg)
	e2:SetOperation(c30000017.spop)
	c:RegisterEffect(e2)
	--spsummon2
	...
	e3:SetCountLimit(1,30000017)
	e3:SetTarget(c30000017.sptg2)
	e3:SetOperation(c30000017.spop2)
	c:RegisterEffect(e3)
end
...
function c30000017.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		local res=Duel.GetLocationCount(tp,LOCATION_MZONE)>0
			and Duel.IsExistingMatchingCard(c30000017.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,mg1,nil,c)
		if not res then
...
function c30000017.spop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if not c:IsRelateToEffect(e) or c:IsImmuneToEffect(e) then return end
	local mg1=Duel.GetMatchingGroup(c30000017.filter1,tp,LOCATION_HAND,0,c,e)
...
function c30000017.sptg2(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then
...
function c30000017.spop2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsFacedown() or not c:IsRelateToEffect(e) or c:IsImmuneToEffect(e) then return end
	local mg1=Duel.GetMatchingGroup(c30000017.filter1,tp,LOCATION_MZONE,0,c,e)
	local sg1=Duel.GetMatchingGroup(c30000017.filter2,tp,LOCATION_EXTRA,0,nil,e,tp,mg1,nil,c)
	local mg2=nil
	local sg2=nil
	local ce=Duel.GetChainMaterial(tp)
