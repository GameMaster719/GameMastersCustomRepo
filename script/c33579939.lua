...
function c33579939.initial_effect(c)
--atkdown
local e3=Effect.CreateEffect(c)
e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS+EFFECT_TYPE_TRIGGER_F)
e3:SetCode(EVENT_PHASE+PHASE_END)
e3:SetRange(LOCATION_MZONE)
e3:SetCondition(c33579939.atkcon)
e3:SetOperation(c33579939.atkop)
e3:SetCountLimit(1)
c:RegisterEffect(e3)
end

function c33579939.atkcon(e,tp,eg,ep,ev,re,r,rp)
return Duel.GetTurnPlayer()==1-tp and e:GetHandler():IsDefensePos()
end

function c33579939.atkop(e,tp,eg,ep,ev,re,r,rp)
