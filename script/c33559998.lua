...
c:SetUniqueOnField(1,1,33559998)
...
e4:SetDescription(aux.Stringid(33559998,1))
...
e5:SetDescription(aux.Stringid(33559998,2))
...
e6:SetProperty(EFFECT_FLAG_SINGLE_RANGE+EFFECT_FLAG_DELAY+EFFECT_FLAG_CANNOT_DISABLE)
...
e7:SetDescription(aux.Stringid(33559998,0))
...
e18:SetProperty(EFFECT_FLAG_PLAYER_TARGET+EFFECT_FLAG_CANNOT_DISABLE)
e18:SetTargetRange(1,0)
e18:SetTarget(c33559998.splimit)
c:RegisterEffect(e18)
end
function c33559998.splimit(e,c,tp,sumtp,sumpos)
