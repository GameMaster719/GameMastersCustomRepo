...
return eg:IsExists(c33599996.cfilter,1,nil,tp) or eg:IsExists(c33599996.cfilter,1,nil,1-tp)
end
...
local g=eg:Filter(c33599996.filter,nil,e,e:GetHandlerPlayer())
...
if chk==0 then return Duel.IsExistingTarget(c33599996.filter1,tp,LOCATION_MZONE,0,5,nil) or Duel.IsExistingTarget(c33599996.filter1,tp,0,LOCATION_MZONE,5,nil) end
end
