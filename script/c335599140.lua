--lightforce sword
function c335599140.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c335599140.target)
	e1:SetOperation(c335599140.activate)
	c:RegisterEffect(e1)
--act qp in hand
...
function c335599140.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(Card.IsAbleToRemove,tp,0,LOCATION_HAND,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_REMOVE,nil,1,1-tp,LOCATION_HAND)
end
function c335599140.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Remove(card,POS_FACEDOWN,REASON_EFFECT)>0 then
		...
		e1:SetCondition(c335599140.thcon)
		e1:SetOperation(c335599140.thop)
		e1:SetLabel(1)
		card:RegisterEffect(e1)
		e:GetHandler():RegisterFlagEffect(1082946,RESET_PHASE+PHASE_END+RESET_SELF_TURN,0,3)
		c335599140[e:GetHandler()]=e1
	end
end
function c335599140.thcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c335599140.thop(e,tp,eg,ep,ev,re,r,rp)
	local ct=e:GetLabel()
