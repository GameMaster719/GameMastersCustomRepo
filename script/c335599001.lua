...
ge2:SetOperation(c335599001.clear)
Duel.RegisterEffect(ge2,0)
end
end

function c335599001.checkop(e,tp,eg,ep,ev,re,r,rp)
if ep==Duel.GetTurnPlayer() then
local val=math.ceil(ev/2)
table.insert(c335599001[ep],val)
end
end

function c335599001.clear(e,tp,eg,ep,ev,re,r,rp)
c335599001[2]={table.unpack(c335599001[Duel.GetTurnPlayer()])}
c335599001[Duel.GetTurnPlayer()]={}
end
...
function c335599001.tg4(e,tp,eg,ep,ev,re,r,rp,chk)
if chk==0 then return c335599001[2][1] end
Duel.SetTargetPlayer(tp)
Duel.SetTargetParam(c335599001[2][1])
Duel.SetOperationInfo(0,CATEGORY_RECOVER,nil,0,tp,c335599001[2][1])
table.remove(c335599001[2],1)
end
