...
if not Duel.IsPlayerCanSpecialSummonMonster(tp,511005652,0,0x4011,1200,1200,3,RACE_REPTILE,ATTRIBUTE_EARTH) then return end
local token=Duel.CreateToken(tp,511005652)
