...
c:RegisterEffect(e2)
--Special Summon opponents attached monsters
...
function c33569999.filter(c)
return c:IsFaceup() and  c:GetAttack()>0
end

function c33569999.mttarget(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
if chk==0 then return e:GetHandler()
	and Duel.IsExistingTarget(c33569999.filter,tp,0,LOCATION_MZONE,1,nil) end
Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
Duel.SelectTarget(tp,c33569999.filter,tp,0,LOCATION_MZONE,1,1,nil)
end
