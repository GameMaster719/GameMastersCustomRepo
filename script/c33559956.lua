--Clear Prism Mothman
function c33559956.initial_effect(c)
	--pendulum summon
	...
	e1:SetCondition(c33559956.spcon)
	e1:SetOperation(c33559956.spop)
	c:RegisterEffect(e1)
	--summon eff 
	...
	e2:SetCondition(c33559956.condition)
	e2:SetOperation(c33559956.operation)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
...
function c33559956.Pcost(e,tp,eg,ep,ev,re,r,rp,chk)
