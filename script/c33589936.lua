...
local token=Duel.CreateToken(tp,511005654)
Duel.SendtoHand(token,tp,2,REASON_EFFECT)
local token2=Duel.CreateToken(tp,511005768)
Duel.SendtoHand(token2,tp,2,REASON_EFFECT)
local token3=Duel.CreateToken(tp,44095762)
Duel.SendtoHand(token3,tp,2,REASON_EFFECT)	
local token4=Duel.CreateToken(tp,12580477)
Duel.SendtoHand(token4,tp,2,REASON_EFFECT)	
--5
local token5=Duel.CreateToken(tp,511005648)
Duel.SendtoHand(token5,tp,2,REASON_EFFECT)
local token6=Duel.CreateToken(tp,511005686)
Duel.SendtoHand(token6,tp,2,REASON_EFFECT)
local token7=Duel.CreateToken(tp,33589910)
Duel.SendtoHand(token7,tp,2,REASON_EFFECT)		
local token8=Duel.CreateToken(tp,511005794)
Duel.SendtoHand(token8,tp,2,REASON_EFFECT)	
		
local token10=Duel.CreateToken(tp,511005791)
...
local c=e:GetHandler()
local tp=c:GetControler()
local token=Duel.CreateToken(tp,511005794)
Duel.SendtoHand(token,tp,2,REASON_EFFECT)
local token2=Duel.CreateToken(tp,511005791)
Duel.SendtoHand(token2,tp,2,REASON_EFFECT)
...
Duel.SendtoHand(token6,tp,2,REASON_EFFECT)
local token7=Duel.CreateToken(tp,511005768)
Duel.SendtoHand(token7,tp,2,REASON_EFFECT)		
local token8=Duel.CreateToken(tp,511005654)
Duel.SendtoHand(token8,tp,2,REASON_EFFECT)	
local token9=Duel.CreateToken(tp,511005790)
