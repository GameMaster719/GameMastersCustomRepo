...
function c335599155.initial_effect(c)
	--ATK/DEF dOWN 500
	...
	e1:SetCondition(c335599155.condition)
	e1:SetOperation(c335599155.operation)
	c:RegisterEffect(e1)
end

function c335599155.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c335599155.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
