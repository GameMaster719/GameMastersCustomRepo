...
function c335599174.initial_effect(c)
	--opponent skips main phase 1
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetCode(EFFECT_SKIP_M1)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(0,1)
	e1:SetCondition(c335599174.condition)
...
c335599174.collection={ [511005597]=true; [7914843]=true; [5257687]=true; [75285069]=true; [39180960]=true; [70307656]=true; [2792265]=true; [4035199]=true; [78636495]=true; [44913552]=true; [31242786]=true;  }


function c335599174.condition(e)
	return e:GetHandler():IsDefensePos()
end

function c335599174.ct_check(c)
	return c:GetAttack()>=1500 and not c335599174.collection[c:GetCode()]
end


function c335599174.filter2(c)
...
function condition2(e)
  return
   not c335599174.filter2(Duel.GetFieldCard(0,LOCATION_SZONE,5)) and
   not c335599174.filter2(Duel.GetFieldCard(1,LOCATION_SZONE,5))
end
...
function desop(e,tp,eg,ep,ev,re,r,rp)
    ...
    if seq>0 then
        ...
        if tc and c335599174.ct_check(tc) then g:AddCard(tc) end
    end
    if seq<4 then
        local tc=Duel.GetFieldCard(tp,LOCATION_MZONE,seq+1)
       if tc and c335599174.ct_check(tc) then g:AddCard(tc) end
