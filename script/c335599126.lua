...
function c335599126.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(335599126,0))
	e4:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e4:SetCode(EVENT_BATTLE_DESTROYED)
	e4:SetCondition(c335599126.con4)
	e4:SetTarget(c335599126.tg4)
	e4:SetOperation(c335599126.op4)
	c:RegisterEffect(e4)
end
...
function c335599126.con4(e,tp,eg,ep,ev,re,r,rp)
	return  e:GetHandler():IsReason(REASON_BATTLE)
end
function c335599126.tg4(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c335599126.op4(e,tp,eg,ep,ev,re,r,rp)
