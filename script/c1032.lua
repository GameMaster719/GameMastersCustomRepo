...
function c1032.initial_effect(c)
	...
	e4:SetCondition(c1032.condition2)
	e4:SetOperation(c1032.operation2)
	c:RegisterEffect(e4)
end
function c1032.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetSummonType()==SUMMON_TYPE_SYNCHRO
end
function c1032.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c1032.value(e,c)
	return math.abs(Duel.GetLP(0)-Duel.GetLP(1))
end
function c1032.condition2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_MZONE) and e:GetHandler():IsSummonType(SUMMON_TYPE_SYNCHRO)
end
function c1032.operation2(e,tp,eg,ep,ev,re,r,rp)
