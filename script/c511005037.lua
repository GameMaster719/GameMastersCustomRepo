...
function self.cd(e,tp,eg,ep,ev,re,r,rp)
  return Duel.IsExistingMatchingCard(Card.IsSetCard,tp,LOCATION_SZONE,0,2,nil,0x1034)
end
...
function self.tg(e,tp,eg,ep,ev,re,r,rp,chk)
  if chk==0 then return Duel.IsExistingMatchingCard(self.sp_fil,tp,LOCATION_DECK,0,1,nil,e,tp) end
